...
const sessionPath = path.join(sessionDir, 'creds.json');  fs.writeFileSync(sessionPath, JSON.stringify(response.data.credsData), 'utf8');
...
const sessionPath = path.join(sessionDir, 'creds.json');
      ...
      const cleanB64 = b64data.replace('...', ''); // Optional, depending on formatting
...
global.myName = 'gifted_api_56yjJ568dte4'; // Your custom key
global.caption = "*𝐏𝐑𝐈𝐍𝐂𝐄 𝐌𝐃𝐗𝐈*";
global.api = "https://api.giftedtech.web.id/api"; // wow you brought them here
...
module.exports = {  GiftedAnticall, GiftedFancy, Giftedttstalk, giftedCdn, loadSession, makeId, convertStickerToImage, GiftedApkDl, giftedTempmail, getBuffer, monospace, getGroupAdmins, getRandom, h2k, isUrl, Json, runtime, sleep , toAudio, toPTT, eBasef, dBasef, eBinary, dBinary, toVideo, ffmpeg, fetchJson };
